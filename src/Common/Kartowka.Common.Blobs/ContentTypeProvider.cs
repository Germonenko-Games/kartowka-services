...
public class ContentTypeProvider : IContentTypeProvider
{
    ...
    public ContentTypeProvider() : this(GetDefaultMapping())
    {
    }
    
    public ContentTypeProvider(IReadOnlyDictionary<string, string> mapping)
    {
        Mappings = mapping;
    }
    ...
    public bool TryGetContentType(string fileExtension, out string contentType)
    {
        ...
        if (Mappings.TryGetValue(fileExtension, out var type))
        {
            contentType = type;
            return true;
        }
    ...
    {
        foreach (var (ext, type) in Mappings)
        {
    ...
    private static Dictionary<string, string> GetDefaultMapping() => new(StringComparer.OrdinalIgnoreCase)
    {
        { "323", "text/h323" },
        { "3g2", "video/3gpp2" },
        { "3gp2", "video/3gpp2" },
